...
class DocGenerator:
    ...
    def generate_html(self, source_dir: str, output_dir: str):
        ...
        if not os.path.isdir(source_dir):
            return {"status": "error", "errors": f"Source directory not found: {source_dir}"}
        ...
        try:
            ...
            return {"status": "error", "errors": "Sphinx is not installed. Please install it with \"pip install Sphinx\""}
